...
const mapStateToProps = state => {
  return {
    accessFrequency: state.dashboard.accessFrequency,
    peakFlow: state.dashboard.peakFlow,
    userSitua: state.dashboard.userSitua,
    trafficSitua: state.dashboard.trafficSitua,
  };
};
