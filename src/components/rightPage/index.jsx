...
import earthImg from '../../assets/images/earth-rotate.gif'
import {
  RightPage,
  RightTopBox,
  RightCenterBox,
...
const mapStateToProps = state => {
  return {
    browseCategories: state.dashboard.browseCategories,
    userIdentityCategory: state.dashboard.userIdentityCategory,
